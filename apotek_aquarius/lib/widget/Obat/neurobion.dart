...
class Neurobion extends StatefulWidget {
  const Neurobion({super.key});

  @override
  State<Neurobion> createState() => _NeurobionState();
}

class _NeurobionState extends State<Neurobion> {
  @override
        ...
        child: SafeArea(
          ...
          children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage("assets/neurobion.jpg"))),
                ),
                Positioned(
                    top: 16,
                    left: 16,
            ...
            const Deskripsi(
              title: "Deskripsi",
              deskripsi:
                  "Mencegah atau mengatasi gejala akibat gangguan saraf (neuropati) akibat kekurangan vitamin B1, B6, dan B12.",
            ),
            const SizedBox(
              height: 30,
            ),
