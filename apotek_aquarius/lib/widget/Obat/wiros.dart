...
class Wiros extends StatefulWidget {
  const Wiros({super.key});

  @override
  State<Wiros> createState() => _WirosState();
}

class _WirosState extends State<Wiros> {
  @override
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage("assets/wiros.jpg"))),
                ),
                Positioned(
                    top: 16,
                    left: 16,
