...
class SanmolDrops extends StatefulWidget {
  const SanmolDrops({super.key});

  @override
  State<SanmolDrops> createState() => _SanmolDropsState();
}

class _SanmolDropsState extends State<SanmolDrops> {
  @override
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage("assets/sanmol_drop.jpg"))),
                ),
                Positioned(
                    top: 16,
                    left: 16,
